   ...
   if(cols[1] != 'all') {
      if(cols[1] %in% c('brief', 'normal', 'long', 'all'))
         cols <- switch(cols,
                        ...
                        normal = c('id', 'name', 'site', 'method', 'launched', 'status', 'error', 'vars', 'cases', 'CCR', 'kappa', 'cores',
                                   'cpu', 'cpu_pct', 'mem_req', 'mem_gb', 'walltime', 'gpu', 'gpu_pct', 'gpu_mem', 'comment_launch', 'score', 'comment_assess', 'comment_map'),
                        long = c('id', 'name', 'site', 'method', 'launched', 'status', 'success', 'error', 'message', 'vars', 'cases', 'CCR', 'kappa', 'cores',
