...
fit('oth_1m', bypoly = 'bypoly01', min_class = 100, comment = 'oth 1m bypoly01 min=100')
fit('oth_1m', bypoly = 'bypoly02', min_class = 100, comment = 'oth 1m bypoly02 min=100')
fit('oth_1m', bypoly = 'bypoly03', min_class = 100, comment = 'oth 1m bypoly03 min=100')
fit('oth_1m', bypoly = 'bypoly04', min_class = 100, comment = 'oth 1m bypoly04 min=100')
fit('oth_1m', bypoly = 'bypoly05', min_class = 100, comment = 'oth 1m bypoly05 min=100')
...
fit('peg_1m', bypoly = 'bypoly02', min_class = 100, comment = 'peg 1m bypoly02 min=100')
...
fit('peg_50cm', bypoly = 'bypoly02', min_class = 100, comment = 'peg 50cm bypoly02 min=100')
...
sample('oth_1m', p = 1, balance = TRUE, balance_excl = c(7, 8, 9, 10, 11, 15, 21:33), reclass = c(13, 2))
fit('oth_1m', bypoly = 'bypoly01', min_class = 75, comment = 'more bal upscaled 1m bypoly01 min=100')
fit('oth_1m', bypoly = 'bypoly02', min_class = 75, comment = 'more bal upscaled 1m bypoly02 min=100')
fit('oth_1m', bypoly = 'bypoly03', min_class = 75, comment = 'more bal upscaled 1m bypoly03 min=100')
fit('oth_1m', bypoly = 'bypoly04', min_class = 75, comment = 'more bal upscaled 1m bypoly04 min=100')
fit('oth_1m', bypoly = 'bypoly05', min_class = 75, comment = 'more bal upscaled 1m bypoly05 min=100')
