...
modelsdir <- 'C:/Work/saltmarsh/models/' 
...
predictdir <- 'c:/Work/saltmarsh/data/oth/predicted'
...
```{r}
print(marshmap::unconfuse(model_fit)$confuse, mode = 'prec_recall')                          # I'll move unconfuse to fit, so won't need it here
```
#### Note
...
- The *No Information Rate* is the CCR (expressed as a proportion) you'd get if you always bet the majority class. In this particular 
...
```{r}
classes <- marshmap::read_pars_table('classes')[, c('subclass', 'subclass_name')] 
