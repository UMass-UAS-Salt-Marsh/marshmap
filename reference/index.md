...
- [`unet_assess()`](https://umass-uas-salt-marsh.github.io/marshmap/reference/unet_assess.md)
  : Simple wrapper for single-stage assessment (existing behavior)
- [`unet_assess_hierarchical()`](https://umass-uas-salt-marsh.github.io/marshmap/reference/unet_assess_hierarchical.md)
